...
namespace locales
{
    ...
    enum LocaleType
    {
        ...
        Start, Cancel, Info, Close, License, Ok, ShowAgainButton,

        LeftTeam, RightTeam, BotsLeft, BotsRight, Bots, Fraglimit,
        InfoSB, ShortDescriptionSB, InfoDM,
        ShortDescriptionDM, InfoTDM, ShortDescriptionTDM, InfoCK, ShortDescriptionCK,
        
        DebuggingInformation, AIJobs, Zones, AIPaths, GameInformation, FramesPerSecond, ParticleCount,
        
        ParticleCountSlider, ParticleLifetime, GameSettings, Fullscreen, VerticalSynchronisation,
        MusicVolume, SoundVolume, AnnouncerVolume,
        Name,
        Accelerate, TurnLeft, TurnRight, Fire, ShipName, PlayerColor,
        TeamColor, ScreenShotFormat, ShowToolTips, WeaponOptions,
        
        AboutText, LicenseText, QuitText, QuitCurrentGameText, StartNetworkText, JoinNetworkText, HideMenuText,
        
        Add, BackSlash, Comma, Dash,
        ...
        Up, Display, Audio, WindowSettings, StartTutorial, Next,
        
        Tut01, TutText01, Tut02, TutText02, Tut03, TutText03,
        Tut04, TutText04, Tut05, TutText05, Tut06, TutText06,
        Tut07, TutText07, Tut08, TutText08,
        VolumeSettings,
        Tut09, TutText09, Tut10, TutText10,
        AudioNextKey, PlaybackSettings,
        Tut11, TutText11, Tut12, TutText12, Tut13, TutText13,
        Tut14, TutText14, Tut15, TutText15, Tut16, TutText16,
        Tut17, TutText17, Tut18, TutText18, Tut19, TutText19, Tut20, TutText20,
        ...
        ttFramesPerSecond, ttParticleCount, ttShowToolTips,
        ...
        Tut23, TutText23, Tut24, TutText24, Tut25, TutText25,
        Tut26, TutText26, Tut27, TutText27, Tut28, TutText28,
        
        PlayerOptions, Artist, Album, PreviousTrackNotify,
        ...
        BlackHoles, Suns,
        Turrets, OnHome, OnPlanets, AttackSpeed,
