...
TextEdit::TextEdit (const sf::String& text, sf::String& value, const sf::String& fallBack,
...
void TextEdit::draw() const
{
    ...
    {
        int pos = text::getCharacterPos(value_, cursorPos_ * scale_, 12.f, TEXT_ALIGN_CENTER) + 2;
