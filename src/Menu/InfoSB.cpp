...
UiWindow* InfoSB::get()
{
    if (instance_ == NULL)
    {
        ...
        instance_->addWidget(new Label(new sf::String("SpaceBall"), TEXT_ALIGN_LEFT, Vector2f(10,10), 20.f, getColor3f(0.5f, 0.9f, 1.f), false));
        ...
        instance_->addWidget(new TextBox(locales::getLocale(locales::ShortDescriptionSB), Vector2f(10,40), 300, 30, getColor3f(0.7f, 0.9f, 1.f)));
