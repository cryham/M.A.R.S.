...
UiWindow* WeaponOptions::get()
{
    if (instance_ == NULL)
    {
        ...
        //  weapons
        int x = 20, y = 80, yadd = 20;
        instance_->addWidget(new LabeledBox(locales::getLocale(locales::Weapons), Vector2f(x-10, y-30), 100, 210));
        instance_->addWidget(new Checkbox(new sf::String("AFK-47"), NULL, &kAFK_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("WT-FLAMER"), NULL, &kBurner_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("FIST OF ALI"), NULL, &kFist_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("FLUBBA"), NULL, &kFlubba_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("SHOTGUN"), NULL, &kShotgun_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("ROCK'n'LOL"), NULL, &kRocket_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("ROFLE"), NULL, &kRofle_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("H2-OMG"), NULL, &kH2OMG_, Vector2f(x,y), 100));  y += yadd;
        //  weapons2
        x += 150;  y = 80;
        instance_->addWidget(new LabeledBox(locales::getLocale(locales::Weapons), Vector2f(x-10, y-30), 100, 210));
        instance_->addWidget(new Checkbox(new sf::String("AFK-85"), NULL, &kAFK2_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("WT-Flamer2"), NULL, &kFlamer2_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("Plasma"), NULL, &kPlasma_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("Shotgun2"), NULL, &kShotgun2_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("MiniRockets"), NULL, &kMiniRockets_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("Rifle2"), NULL, &kRifle2_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("H2OStorm"), NULL, &kH2OStorm_, Vector2f(x,y), 100));  y += yadd;
        //  special
        x += 150;  y = 80;
        instance_->addWidget(new LabeledBox(locales::getLocale(locales::Specials), Vector2f(x-10, y-30), 100, 210));
        instance_->addWidget(new Checkbox(new sf::String("FREEZER"), NULL, &kFreeze_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("HEAL"), NULL, &kHeal_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("BLAST"), NULL, &kBlast_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("FIRE WALL"), NULL, &kFireWall_, Vector2f(x,y), 100));  y += yadd;
        instance_->addWidget(new Checkbox(new sf::String("SHOCKER"), NULL, &kShocker_, Vector2f(x,y), 100));  y += yadd;
    }
    return instance_;
}
...
void WeaponOptions::onShow()
{
    ...
    kFlubba_ = settings::C_EnabledWeaponsByUser & weapons::wFlubba;
    ...
    kAFK2_ = settings::C_EnabledWeaponsByUser & weapons::wAFK85;
    kFlamer2_ = settings::C_EnabledWeaponsByUser & weapons::wFlamer2;
    kPlasma_ = settings::C_EnabledWeaponsByUser & weapons::wPlasma;
    kShotgun2_ = settings::C_EnabledWeaponsByUser & weapons::wShotgun2;
    kMiniRockets_ = settings::C_EnabledWeaponsByUser & weapons::wMiniRockets;
    kRifle2_ = settings::C_EnabledWeaponsByUser & weapons::wRifle2;
    kH2OStorm_ = settings::C_EnabledWeaponsByUser & weapons::wH2OStorm;
