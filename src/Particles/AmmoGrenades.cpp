...
AmmoGrenades::AmmoGrenades(
    ...
    Player* damageSource)
    :Particle<AmmoGrenades>(spaceObjects::oAmmoGrenades, location, 8.f, 1.0f, randomizer::random(12.f, 15.f))
{
...
void AmmoGrenades::update()
{
    ...
    if (lifeTime_ > totalLifeTime_)
    {
        ...
        //     particles::spawn(particles::pMiniAmmoGrenades, location_, Vector2f(), Vector2f(), Color3f(), damageSource_);
    }
}
