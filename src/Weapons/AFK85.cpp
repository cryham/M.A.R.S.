...
void AFK85::draw(float alpha) const
{
    ...
    glBegin(GL_QUADS);
        ...
        glTexCoord2f(posX*0.125f,     posY*0.03125f);    glVertex2f(0, -1.f*r*0.95f);
        glTexCoord2f(posX*0.125f,    (posY+1)*0.03125f); glVertex2f(0, -1.f*r*0.45f);
        glTexCoord2f((posX+1)*0.125f,(posY+1)*0.03125f); glVertex2f(r*1.5f, -1.f*r*0.45f);
        glTexCoord2f((posX+1)*0.125f, posY*0.03125f);    glVertex2f(r*1.5f, -1.f*r*0.95f);
    glEnd();
}
