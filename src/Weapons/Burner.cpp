...
void Burner::draw(float alpha) const
{
    ...
    glBegin(GL_QUADS);
        ...
        glTexCoord2f(posX*0.125f,    (posY+1)*0.03125f); glVertex2f(0, -1.f*r*0.3f);
        glTexCoord2f((posX+1)*0.125f,(posY+1)*0.03125f); glVertex2f(r*3.f, -1.f*r*0.3f);
        glTexCoord2f((posX+1)*0.125f, posY*0.03125f);    glVertex2f(r*3.f,      r*0.3f);
    glEnd();
}
